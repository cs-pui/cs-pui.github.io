...
- permanent positions (mostly likely tenure-track) [_why?_](faq.qmd#scope)
- universities that identify as **primarily-undergraduate institutions** [_why?_](faq.qmd#scope)
- institutions that highly value teaching, but also _secure time and financial resources for faculty to remain engaged with research_. [_what does this mean?_](faq.qmd#research)
...
### Currently Active Searches {#sec-all-deadlines}
